...
//
//
//  Copyright(c) 2005-2025 Luxand, Inc.
//         http://www.luxand.com
//
///////////////////////////////////////////////////
...
#define FSDKE_PLUGIN_NOT_LOADED                 -30
#define FSDKE_PLUGIN_NO_PERMISSION              -31
#define FSDKE_FACEID_NOT_FOUND                  -32
#define FSDKE_FACEIMAGE_NOT_FOUND               -33
...
int _FSDKIMPORT_ FSDK_DetectFace2(HImage Image, TFace* Face);
int _FSDKIMPORT_ FSDK_DetectMultipleFaces2(HImage Image, int* DetectedCount, TFace* FaceArray, int MaxSize);
...
int _FSDKIMPORT_ FSDK_LoadImageFromPngBufferWithAlpha(HImage * Image, const unsigned char * Buffer, unsigned int BufferLength);
...
int _FSDKIMPORT_ FSDK_GetFaceTemplate2(const HImage Image, FSDK_FaceTemplate* FaceTemplate);
int _FSDKIMPORT_ FSDK_GetFaceTemplateInRegion2(const HImage Image, const TFace* Face, FSDK_FaceTemplate* FaceTemplate);
// Webcam usage
...
int _FSDKIMPORT_ FSDK_GetTrackerFace(HTracker Tracker, long long CameraIdx, long long ID, TFace* Face);
...
int _FSDKIMPORT_ FSDK_GetTrackerIDsCount(HTracker Tracker, long long * Count);
int _FSDKIMPORT_ FSDK_GetTrackerAllIDs(HTracker Tracker, long long * IDList, long long MaxSizeInBytes);
int _FSDKIMPORT_ FSDK_GetTrackerFaceIDsCountForID(HTracker Tracker, long long ID, long long * Count);
int _FSDKIMPORT_ FSDK_GetTrackerFaceIDsForID(HTracker Tracker, long long ID, long long * FaceIDList, long long MaxSizeInBytes);
int _FSDKIMPORT_ FSDK_GetTrackerIDByFaceID(HTracker Tracker, long long FaceID, long long * ID);
int _FSDKIMPORT_ FSDK_GetTrackerFaceTemplate(HTracker Tracker, long long FaceID, FSDK_FaceTemplate* FaceTemplate);
int _FSDKIMPORT_ FSDK_GetTrackerFaceImage(HTracker Tracker, long long FaceID, HImage * FaceImage);
int _FSDKIMPORT_ FSDK_SetTrackerFaceImage(HTracker Tracker, long long FaceID, HImage FaceImage);
int _FSDKIMPORT_ FSDK_DeleteTrackerFaceImage(HTracker Tracker, long long FaceID);
int _FSDKIMPORT_ FSDK_DeleteTrackerFace(HTracker Tracker, long long FaceID);
int _FSDKIMPORT_ FSDK_TrackerCreateID(HTracker Tracker, const FSDK_FaceTemplate * FaceTemplate, long long * ID, long long * FaceID);
int _FSDKIMPORT_ FSDK_AddTrackerFaceTemplate(HTracker Tracker, long long ID, const FSDK_FaceTemplate * FaceTemplate, long long * FaceID);
int _FSDKIMPORT_ FSDK_TrackerMatchFaces(HTracker Tracker, const FSDK_FaceTemplate * FaceTemplate, float Threshold, IDSimilarity* Buffer, long long * Count, long long MaxSizeInBytes);
